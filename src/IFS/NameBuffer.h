...
#ifndef __IFS_NAMEBUFFER_H
#define __IFS_NAMEBUFFER_H
 ...
 *
 *  Note that 'length' always reflects the _required_ name/path length, and may be longer than size.
 */
struct NameBuffer {
